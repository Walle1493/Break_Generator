...
def Solution3():
    ...
    # model = AutoModelForSeq2SeqLM.from_pretrained("mrm8488/t5-base-finetuned-break_data")
    model = T5ForConditionalGeneration.from_pretrained("/home/mxdong/Model/Decomposition/MuSiQue/T5-Large")
    model.to(torch_device)
...
def Solution6():
    ...
    # model = AutoModelForSeq2SeqLM.from_pretrained("mrm8488/t5-base-finetuned-break_data")
    model = T5ForConditionalGeneration.from_pretrained("/home/mxdong/Model/Decomposition/MuSiQue/T5-Base")
    model.to(torch_device)
