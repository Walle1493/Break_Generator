...
MODEL_CLASSES = {
    ...
    'xlnet': (XLNetConfig, XLMForSequenceClassification, XLNetTokenizer),
    'xlm': (XLMConfig, XLNetForSequenceClassification, XLMTokenizer),
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            inputs = {
                ...
                if args.model_type in ["bert", "xlnet", "distilbert"]
...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    np.save(output_prediction_file, preds)
    logger.info("***** Eval result {} *****".format(str(prefix)))
...
def load_and_cache_examples(args, tokenizer, evaluate=False):
    ...
    if os.path.exists(cached_features_file) and not args.overwrite_cache:
        ...
        if args.six_classification:
            processor = SixProcessor()
        else:
...
def main():
    ...
    parser.add_argument("--six_classification", action='store_true',
                        help="Run six classification model or else binary classification.")
